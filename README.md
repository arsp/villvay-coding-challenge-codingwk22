...
## World T20 Super 6 qualification scenario simulator

The World T20 cup 2022 has entered its final stage of the Super 6. Six teams made the Super 6, only 5 have a chance to make it to the finals, there isn’t much separating the teams in terms of points or NRR(Net Run Rate). Each team could make it to the final if make to the op two when all fixtures are completed. 

Two teams have already played their quota, England and Afghanistan, surprisingly favourites England have lost all of their matches, while under dogs Afghanistan is the only team with 2 wins. With 2 fixtures remaining, they are not yet safe nor have a guaranteed place in the semi finals, because the next two matches will definitely produce a winner(Rain will never be a problem) and the team with the most wins and best NRR would go through. 
...
This can’t get any closer than this and fans are eager to see how their teams would fair, You as the Software Engineer have been given two days to come up with an algorithm to generate reports for the super 6 qualification scenario simulator.
...
📄 **The report should consist of the following information for a particular team with the best and the worst case scenarios for qualification.**

1. Who should win ? (The team whose win will still gives the ideal chance or has no bearing to the other games, for example teams with lesser wins, or teams with lesser NRRs)
2. To Qualify
...
<aside>
<img src="https://www.notion.so/icons/mathematics_blue.svg" alt="https://www.notion.so/icons/mathematics_blue.svg" width="40px" /> $NRR = (TotalRunsScored/TotalOversFaced) - (TotalRunsConceded/TotalOversBowled)$
